...
<main role="main" class="container">
    <form method="post">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="movie_name" value="<?=$movieData['movie_name'];?>">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" name="movie_release_date" value="<?=$movieData['movie_release_date'];?>">
        </div>
        <div class="input-group mb-3">
            <div class="input-group-prepend">
        ...
        <div class="mb-3">
            ...
            <input type="range" class="form-range" min="0" max="10" name="movie_rating" value="<?=$movieData['movie_rating'];?>">
        </div>
        <div class="mb-3">
            <label class="form-label">Описание фильма</label>
            <input type="text" class="form-control" name="movie_description" value="<?=$movieData['movie_description'];?>">
        </div>
        <div class="mb-3">
            <label class="form-label">Награды фильма</label>
            <input type="text" class="form-control" name="movie_awards" value="<?=$movieData['movie_awards'];?>">
        </div>
        <button type="submit" class="btn btn-primary">Изменить фильм</button>
    </form>
</main>
