...
<main role="main" class="container">
    <form method="post">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="producer_name" value="<?= $producerData['producer_name'];?>">
        </div>
        <div class="mb-3">
            <label class="form-label">Дата рождения режиссера</label>
            <input type="date" class="form-control" name="producer_dob" value="<?= $producerData['producer_dob'];?>">
        </div>
        <div class="mb-3">
            <label class="form-label">Страна режиссера</label>
            <input type="text" class="form-control" name="producer_country" value="<?= $producerData['producer_country'];?>">
        </div>
        <div class="mb-3">
            <label class="form-label">Описание режиссера</label>
            <input type="text" class="form-control" name="producer_description" value="<?= $producerData['producer_description'];?>">
        </div>
        <div class="mb-3">
            <label class="form-label">Награды режиссера</label>
            <input type="text" class="form-control" name="producer_awards" value="<?= $producerData['producer_awards'];?>">
        </div>
